...
export interface ApiElanElan extends Schema.CollectionType {
  collectionName: 'elanlar';
  info: {
    singularName: 'elan';
    pluralName: 'elanlar';
    displayName: 'elanlar';
  ...
  attributes: {
    name: Attribute.String;
    room: Attribute.Component<'room.room', true>;
    ...
    createdBy: Attribute.Relation<'api::elan.elan', 'oneToOne', 'admin::user'> &
      Attribute.Private;
